...
const activeFavouritePlaylistIndex = ref(-1)
const activeArtistIndex = ref(-1)
const isFavouritePlaylistsCollapsed = ref(false)
...
const setFavouritePlaylistsCollapsed = (value) => {
    isFavouritePlaylistsCollapsed.value = value
}
...
const isSubtitleVisible = () => {
    if(isPlaylistMode.value) {
        return navigation.value.customPlaylistsShow 
            || navigation.value.favouritePlaylistsShow
