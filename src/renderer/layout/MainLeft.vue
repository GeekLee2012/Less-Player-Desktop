        ...
        <div class="center" @scroll="onUserMouseWheel">
            <div id="explore-mode">
                <div class="mode-item" v-show="isPlaylistMode" @click="switchExploreMode">
                    <svg width="17" height="16" viewBox="0 0 944.3 696.52" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M708.31,372.39v-8.34q0-156,0-311.93c0-25.37,16.52-45.95,40.82-50.95a44.53,44.53,0,0,1,8.93-.86c45.49-.06,91-.33,136.47.06,27.7.23,48.24,20.57,49.69,48C945.75,77,923,100,892.74,100.2c-26,.2-52,0-78,0h-6.44v6.9c0,141.63.32,283.27-.22,424.9-.14,38.73-14.05,73.31-38.94,103-36.08,43.09-82.64,63.69-138.6,61.24-77-3.37-141.93-59.23-158-134.59-16.91-79.43,26.49-160.86,101.88-191.25q65-26.21,129.76.45C705.42,371.43,706.66,371.8,708.31,372.39Zm-69.88,224.4c37.07.85,70.26-30.84,70-70.11-.26-37.75-32.14-69.39-69.9-69.37-37.42,0-69.8,31.56-69.73,70C568.85,564.54,600,597.35,638.43,596.79Z"/><path d="M304.77.24q126,0,251.94,0c23.65,0,42.74,12.63,49.49,32.56,11.72,34.57-11.38,67.1-48.45,67.35-53,.35-106,.09-158.95.09q-172.2,0-344.41,0C42.76,100.3,31.93,98,22.2,91.4,4.59,79.46-2.15,62.24,1,42,4.37,20.61,17.81,6.63,39,1.85,48.29-.25,58.21.1,67.84.08Q186.31-.1,304.77,0Z"/><path d="M304.75,313.65q-126.23,0-252.45,0C24,313.61,4.11,296.1.48,268.34c-3.67-28.15,19.64-54.3,49.43-54.6,37.16-.37,74.32-.09,111.47-.09q198.21,0,396.41,0c27.69,0,48.68,18.82,51.37,45.83,2.81,28.19-19.71,53.72-48.48,54-40.15.39-80.31.14-120.47.14Q372.49,313.67,304.75,313.65Z"/><path d="M213.26,427.24c53.32,0,106.64.12,160-.07,17.11-.06,31.79,5.55,42.08,19.05,12.19,16,14.82,34.08,5.74,52.63-9.55,19.51-26.13,28.28-47.37,28.34-55.32.16-110.64.06-166,.06q-77.47,0-155,0c-19.57,0-35.63-7.47-45.64-24.61-19.34-33.09,2.91-74.14,41.2-75.06,40.63-1,81.3-.28,122-.31Z"/></g></g></svg>
                    <span>分类歌单</span>
                </div>
            ...
            <div id="favorite-playlist-list" v-show="isPlaylistMode && navigation.favoritePlaylistsShow">
                <div class="subtitle">
                    ...
                    -->
                    <svg v-show="isFavoritePlaylistsCollapsed" class="expand-btn" @click="setFavoritePlaylistsCollapsed(false)" width="11" height="11" viewBox="0 0 455.71 818.08" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><g id="Layer_2-2" data-name="Layer 2"><g id="Layer_1-2-2" data-name="Layer 1-2"><path d="M354.54,413c-2.89-1.94-5-2.89-6.47-4.41Q181.42,241.85,14.81,75.08C1.75,62-3.43,46.91,2.34,29.08,11.92-.46,49.26-9.71,71.91,11.71c7.87,7.44,15.35,15.29,23,23L440.49,380.64c20.22,20.24,20.29,45.1.22,65.21Q262.27,624.5,83.9,803.2c-9.12,9.14-19.48,15.07-32.63,14.88-17.18-.25-30.24-8-37.94-23.27C5.54,779.38,7.14,764.15,17.22,750a61.07,61.07,0,0,1,6.7-7.4q162.34-162.55,324.74-325C349.94,416.3,351.53,415.32,354.54,413Z"/></g></g></g></g></svg>
                    <svg v-show="!isFavoritePlaylistsCollapsed" class="collapse-btn" @click="setFavoritePlaylistsCollapsed(true)" width="11" height="11" viewBox="0 0 763.32 424.57" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M380.47,322.11c27.6-27.5,54-53.68,80.23-80Q575,127.75,689.38,13.4C708.7-5.81,735-2.92,750.83,12.91c17,17,16.57,43.39-.9,60.87L414.1,409.61c-19.89,19.89-45,20-64.9.08Q180.9,241.45,12.66,73.15A42.53,42.53,0,1,1,72.85,13Q224.7,164.87,376.48,316.73A46.1,46.1,0,0,1,380.47,322.11Z"/></g></g></svg>
                </div>
                <ul v-show="!isFavoritePlaylistsCollapsed">
                    <li v-for="(item, index) in getFavoritePlaylilsts()" 
                        :class="{ active: (activeFavoritePlaylistIndex == index) }"
                        @click="visitFavourteItem(item, index)" 
                        @contextmenu="(e) => showContextMenu(item, index, e, 8)"
                        v-html="item.title" >
                    </li>
                </ul>
            </div>
