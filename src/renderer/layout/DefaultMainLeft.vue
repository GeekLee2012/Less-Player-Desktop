...
const { showContextMenu, useWindowsStyleWinCtl } = inject('appCommon')
...
const { isMaxScreen, isPlaylistMode, isArtistMode,
    isRadioMode, isUserHomeMode, exploreModeCode, exitToHomeBtnShow } = storeToRefs(useAppCommonStore())
        ...
        <div class="center" @scroll="onUserMouseWheel">
            <div id="explore-mode">
                <div class="mode-item" v-show="isPlaylistMode" @click="switchExploreMode">
                    <svg width="20" height="19" viewBox="0 -20 895.95 703.92" xmlns="http://www.w3.org/2000/svg">
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="Layer_1-2" data-name="Layer 1">
                                <path
                ...
                <div class="mode-item" v-show="isArtistMode" @click="switchExploreMode">
                    <svg width="20" height="17" viewBox="0 0 829.44 853.21" xmlns="http://www.w3.org/2000/svg">
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="Layer_1-2" data-name="Layer 1">
                                <path
                ...
                <div class="mode-item excluded-mode-item" v-show="isUserHomeMode" @click="">
                    ...
                    -->
                    <svg width="20" height="20" viewBox="0 0 938.36 854" xmlns="http://www.w3.org/2000/svg">
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="Layer_1-2" data-name="Layer 1">
                                <path
                ...
                <div class="exit-btn" v-show="isUserHomeMode" @click="() => visitHome()">
                    <svg width="16" height="16" viewBox="0 0 640.23 768.15" xmlns="http://www.w3.org/2000/svg">
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="Layer_1-2" data-name="Layer 1">
                                <path
