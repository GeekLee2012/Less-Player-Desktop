                ...
                <div class="flex-space">
                    <div class="listen-btn">
                        <div class="play-btn" @click="randomPlay">
                            <svg width="15" height="15" viewBox="0 0 139 139"  xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M117.037,61.441L36.333,14.846c-2.467-1.424-5.502-1.424-7.972,0c-2.463,1.423-3.982,4.056-3.982,6.903v93.188  c0,2.848,1.522,5.479,3.982,6.9c1.236,0.713,2.61,1.067,3.986,1.067c1.374,0,2.751-0.354,3.983-1.067l80.704-46.594  c2.466-1.422,3.984-4.054,3.984-6.9C121.023,65.497,119.502,62.866,117.037,61.441z"/></svg>
                            <div class="text">随便听听</div>
                        </div>
                        <svg @click="toggleRandomMusicToolbar" class="down-btn" width="15" height="15" viewBox="0 0 763.32 424.57" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M380.47,322.11c27.6-27.5,54-53.68,80.23-80Q575,127.75,689.38,13.4C708.7-5.81,735-2.92,750.83,12.91c17,17,16.57,43.39-.9,60.87L414.1,409.61c-19.89,19.89-45,20-64.9.08Q180.9,241.45,12.66,73.15A42.53,42.53,0,1,1,72.85,13Q224.7,164.87,376.48,316.73A46.1,46.1,0,0,1,380.47,322.11Z"/></g></g></svg>
                    </div>
                </div>
                <div class="action" >
                    ...
                    <span class="lyric-btn spacing" 
                        :class="{ 'lyric-show': isLyricShow }"
                        @click="toggleLyric">
                        词
                    </span>
                    <span class="text-color-btn spacing" 
                        :class="{ 'text-color-black': textColorIndex == 1 }"
                        @click="switchTextColor">
                        T
                    </span>
                    <span @click="switchToFallbackLayout" class="spacing" >
                        <svg width="17" height="16" viewBox="0 0 1019 1019" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M0,962V503a24.12,24.12,0,0,0,.86-3.77c2.43-31.82,26.64-54.36,58.5-54.39,21.49,0,43,0,64.46,0,1.75,0,3.5-.14,5.67-.24v-7.5q.18-188.61.35-377.22c0-28.4,14.83-48.4,41.95-56.89A45.21,45.21,0,0,0,178,0H969a65,65,0,0,0,6.86,2.75c21,6,34.13,19.66,40.16,40.47.86,3,2,5.85,3,8.78V837a28.45,28.45,0,0,0-1.9,4.46c-7.47,31.14-28.49,47.71-60.65,47.71H571.84v6.12c0,21,.07,42,0,63-.13,29.91-17,51.36-45.87,58.66-2,.52-4,1.37-6,2.06H51a32.14,32.14,0,0,0-4.91-2.06c-22.53-5.41-37-19.19-43.25-41.49C1.61,971,.93,966.49,0,962ZM249.22,118V447H513c34.42,0,57.07,20.41,60,54.56.92,10.77.91,21.63.92,32.45q.1,114.74,0,229.48v6H900.75V118ZM453.87,564.49H118.26V900.71H453.87Z"/></g></g></svg>
                    </span>
                </div>
            </div>
            <div class="cover">
            ...
            <div class="action" v-show="!isLyricShow">
                ...
                <div class="btm-right">
                    <div @click="switchSpectrum" :class="{ active: spectrumCanvasShow }" >
                        <svg width="18" height="17" viewBox="0 0 1003.7 910.4" xmlns="http://www.w3.org/2000/svg" ><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M558.35,455.05q0,197.71,0,395.43c0,23.94-9.54,42.39-30.94,53.57-35.59,18.6-79.08-5.74-81.67-45.8-1-15.6-.42-31.31-.42-47q0-375.43-.06-750.87c0-24.56,9.72-43.31,31.88-54.49,35.17-17.76,78,6.46,80.72,45.73,1,13.93.45,28,.45,42Q558.39,274.34,558.35,455.05Z"/><path d="M780.91,455.46q0,141.23,0,282.45c0,28-18.79,51.18-45.28,56.25C700.1,801,668.06,774.7,668,738.39c-.15-50.49-.05-101-.05-151.48q0-206.71,0-413.42c0-27.25,16.49-49.55,41.51-56.36,36.49-9.94,71.43,17,71.46,55.38q.11,133,0,266Z"/><path d="M222.78,455.06q0-141.22,0-282.46c0-32.54,25.16-57.78,57.09-57.51,30.91.25,55.77,25.31,55.85,56.8.16,60.49,0,121,0,181.47q0,191.46,0,382.93c0,21.23-8.07,38.4-26.05,49.93-18.3,11.73-37.84,12.56-57,2.36-19.52-10.41-29.86-27.38-29.91-49.57Q222.57,597,222.78,455.06Z"/><path d="M890.65,455.63q0-84.24,0-168.46c.06-26.54,17.39-48.82,42.37-55.06,36.35-9.07,70.42,17.67,70.55,55.71.18,53,0,106,0,159q0,87.72,0,175.45c0,26.81-17,49.41-41.58,55.82-36.91,9.64-71.28-16.95-71.37-55.47C890.55,566.93,890.65,511.28,890.65,455.63Z"/><path d="M113,455.55q0,83.49,0,167c-.05,24.61-13.49,44.63-35.53,53.57C40.25,691.17.17,663.46.08,622.31-.07,558.66,0,495,0,431.36,0,383.54,0,335.72.07,287.9.13,261,17.43,238.43,42.39,232.15c36.22-9.12,70.43,17.3,70.58,55C113.2,343.25,113,399.4,113,455.55Z"/></g></g></svg>
                    </div>
