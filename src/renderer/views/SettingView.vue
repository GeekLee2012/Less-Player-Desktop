    ...
    <div id="setting-view">
        ...
        <div class="center">
            ...
            <div class="data row">
                ...
                <div class="content">
                    <div class="last">
                        <SvgTextButton text="备份" :leftAction="visitDataBackup">
                        </SvgTextButton>
                        <SvgTextButton text="还原" :leftAction="visitDataRestore" class="spacing">
                        </SvgTextButton>
            ...
            <div class="about row last-row">
                ...
                <div class="content">
                    ...
                    <div class="license last">
                        <span>开源许可证：</span>
                        <span class="link" @click="visitLink('https://www.apache.org/licenses/LICENSE-2.0.html')">Apache License 2.0</span>
                    </div>
                </div>
            </div>
        </div>
