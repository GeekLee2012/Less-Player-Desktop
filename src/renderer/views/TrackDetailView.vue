...
export default { name: 'TrackDetailView' }
</script>
            ...
            <div class="right">
                ...
                <div class="action">
                    ...
                    <SvgTextButton text="下一曲播放" :leftAction="playItemLater" class="spacing">
                        <template #left-img>
                            <svg width="17" height="17" viewBox="0 0 1016.14 1016.1" xmlns="http://www.w3.org/2000/svg">
