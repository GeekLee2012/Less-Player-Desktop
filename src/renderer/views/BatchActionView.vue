    ...
    <div id="batch-action-view">
        <div class="header">
            ...
            <div class="tabs">
                <span class="tab" v-for="(tab, index) in typeTabs" 
                    ...
                    v-show="isTabsVisible(tab, index)"
                    v-html="tab.name" >
                </span>
        ...
        <div class="center">
            <div class="action">
                ...
                <SvgTextButton :isDisabled="checkedData.length < 1" 
                    text="添加到" class="spacing addToBtn"
                    v-show="actionShowCtl.addToBtn" 
                    :leftAction="toggleAddCheckedMenu" >
                    <template #left-img>
                ...
                <SvgTextButton :isDisabled="checkedData.length < 1" 
                    text="移动到" class="spacing moveToBtn"
                    v-show="actionShowCtl.moveToBtn" 
                    :leftAction="toggleMoveCheckedMenu" >
                    <template #left-img>
