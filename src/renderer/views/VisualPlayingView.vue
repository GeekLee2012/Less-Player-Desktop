...
const { hidePlayingView, minimize, showToast, 
    switchPlayingViewTheme, switchSpectrumIndex } = useAppCommonStore()
const { getCurrentThemeHlColor } = useSettingStore()
const { currentTrack, mmssCurrentTime, progress, playingIndex, playing, volume } = storeToRefs(usePlayStore())
            ...
            <div class="left-view">
                ...
                <div class="action">
                    ...
                    <div class="btm-right">
                        ...
                        <div class="theme spacing" @click="switchPlayingViewTheme">
