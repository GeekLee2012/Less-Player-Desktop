...
.dynamic-playing-view .container > .bottom.bottom-new .action {
    height: 100%;
}

.dynamic-playing-view .container > .bottom.bottom-new .btm-left {
    flex: 2;
    justify-content: flex-start;
...
.dynamic-playing-view .container > .bottom.bottom-new .btm-left .volume-wrap {
    padding-right: 20px;
}

.dynamic-playing-view .container > .bottom.bottom-new .btm-left .volume-wrap .volume-bar {
    width: 10px;
    /*margin-right: 33px;*/
...
.dynamic-playing-view .container > .bottom.bottom-new .btm-left .volume-wrap:hover .volume-bar {
    width: 88px;
    transition: 0.5s;
}

.dynamic-playing-view .container > .bottom.bottom-new .btm-center {
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
.dynamic-playing-view .container > .bottom.bottom-new .btm-right {
    flex: 2;
...
.dynamic-playing-view .container > .bottom.bottom-new .btm-center .play-ctl {
    flex: 1;
    margin-top: 13px;
}
...
.dynamic-playing-view .container > .bottom.bottom-new .btm-center .slider-bar {
    width: 66%;
    margin: 0px 10px;
}

.dynamic-playing-view .container > .bottom.bottom-new .btm-center .t-current {
    min-width: 59px;
    text-align: end;
}

.dynamic-playing-view .container > .bottom.bottom-new .btm-center .t-duration {
    min-width: 59px;
    text-align: start;
}
