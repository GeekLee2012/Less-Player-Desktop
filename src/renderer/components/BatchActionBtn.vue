...
<template>
    <SvgTextButton class="batch-action-btn" text="批量操作" :disabled="disabled">
        <template #left-img>
            <svg width="17" height="17" viewBox="0 0 160 125" xmlns="http://www.w3.org/2000/svg">
        ...
        <template #right-img>
            <svg v-show="deleteBtn" width="17" height="17" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 256 256">
                <path
