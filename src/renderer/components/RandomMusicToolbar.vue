        ...
        <div class="center">
            ...
            <div class="content-wrap v-spacing">
                <div class="content platform" v-show="navIndex == 0">
                    <div v-for="(item, index) in platforms('random')"
                        class="row" 
                        :class="{ 'v-spacing': index > 0 }">
                        <span>{{ item.name }}：</span>
                ...
                <div class="content type" v-show="navIndex == 1">
                    <div v-for="(item, index) in randomMusicTypes"
                        class="row" 
                        :class="{ 'v-spacing': index > 0 }">
                        <span>{{ item.name }}：</span>
