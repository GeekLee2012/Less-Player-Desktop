...
import { coverDefault, toYyyymmdd, toYyyymmddHhMmSs, extractHhMmSs } from '../../common/Utils';
    ...
    <div class="custom-playlist-item" @contextmenu="onContextMenu">
        ...
        <div class="title-wrap spacing1">
            ...
            <div class="action">
                ...
                <svg @click.stop="editItem" width="16" height="16" class="spacing" viewBox="0 0 992.3 992.23"
                ...
                <svg @click.stop="visitBatch" width="16" height="16" class="spacing" viewBox="0 0 160 125"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                            <path
                ...
                <svg @click.stop="removeItem" width="16" height="16" class="spacing" viewBox="0 0 256 256"
