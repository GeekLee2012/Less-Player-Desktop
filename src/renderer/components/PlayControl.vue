...
<template>
    <div class="play-ctl">
        ...
        <div class="play-prev-btn spacing " @click="playPrevTrack" >
            ...
            -->
            <svg width="18" height="18" viewBox="0 0 892.88 974.69" xmlns="http://www.w3.org/2000/svg" ><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M892.87,488q0,214.21-.11,428.45c0,10.43-.53,21.09-2.67,31.25-4.61,21.79-18.28,30.2-40,26a74.83,74.83,0,0,1-28.75-12.19q-179-124.53-358.08-249.08Q331.34,620.65,199.38,529.05c-16.55-11.48-24-27.38-23.76-46.84.25-19.07,8-34.58,24.16-45.7Q506.41,225.91,813,15.23A128.65,128.65,0,0,1,833,4c26.35-11.87,53.86,3.42,58.72,32.54A99.92,99.92,0,0,1,892.82,53Q892.91,270.47,892.87,488Z"/><path d="M98.92,487.37q0,217.73,0,435.46c0,23.51-12.2,41.44-32.87,48.51-30,10.25-60.8-7.94-65.78-39-.65-4,.12-8.27.12-12.4Q.38,487.7.29,55.49c0-14,2.41-26.8,11.87-37.61A49.79,49.79,0,0,1,67.24,4c19.28,7.09,31.62,24.93,31.64,46.42q.12,133.48,0,267Z"/></g></g></svg>
        </div>
        <div class="play-btn spacing" @click="togglePlay">
            ...
            -->
            <svg v-show="playing" width="15" height="15" class="paused" viewBox="0 0 658.53 1006.16" xmlns="http://www.w3.org/2000/svg" ><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M196.43,503.09q0,200.21,0,400.41c0,20.63-4.42,39.93-15.66,57.45-21.43,33.42-62.66,50.43-102.18,42.14-39.72-8.34-70.5-39.72-76.82-78.67A130.29,130.29,0,0,1,.08,903.55Q-.06,501.88,0,100.21C0,48.38,35,8.27,86.47.9,136.62-6.29,186.73,30.61,194.7,80.79a135,135,0,0,1,1.66,20.88Q196.49,302.37,196.43,503.09Z"/><path d="M462.09,503q0-200.72,0-401.42c0-46.91,29.11-85.51,72.86-97,63.42-16.69,123.47,30.29,123.52,96.79q.12,169,0,337.92,0,232.95,0,465.9c0,38.9-15.56,69.86-50.23,88.7-60,32.57-134.91-2.14-145.21-73a117,117,0,0,1-.9-17Q462.05,703.43,462.09,503Z"/></g></g></svg>
        </div>
