...
<template>
    <div class="navigator">
        ...
        <svg v-show="refreshable" @click="refresh" width="20" height="20" class="spacing" viewBox="0 0 799.98 820.97"
            xmlns="http://www.w3.org/2000/svg">
            <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_1-2" data-name="Layer 1">
                    <path
                        d="M640.18,100.62v-6.2c0-15-.15-30,0-45,.37-30.69,23.44-51.83,53.48-49.2,21.72,1.91,41.07,20.87,42,42.72.91,21.46.47,43,.5,64.48q.08,59.51,0,119c0,25.27-14.79,44.26-38.26,49.29a55.2,55.2,0,0,1-11.42,1q-88.74.09-177.49,0c-27.67,0-47.82-18.66-49.72-45.7-1.72-24.65,18-48.48,42.76-49.65,23.62-1.13,47.32-.5,71-.64,3.9,0,7.81,0,13.19,0-2.33-1.92-3.39-2.88-4.53-3.72C521,132.39,452.94,112.14,378,117.72c-133.55,9.94-242.86,103.89-273.92,234C70.43,492.59,144.38,640.82,277.24,698.83c172,75.09,367.88-19,416.83-200.25a287,287,0,0,0,10-74.55c0-15.44,4.58-28.95,16.53-39.17,14.72-12.6,31.64-15.59,49.47-8.4,18,7.27,28.9,21.26,29.68,40.85C801.2,453.84,796,489.78,786.42,525c-38.68,141.88-150.25,250.21-293.2,285-145.1,35.27-301.35-15.88-397.58-130Q25.26,596.6,6,489.31c-28.87-162.45,48-329,190.23-412.6q105.51-62,227.64-55.15c77.59,4.48,148,30,211,75.44C636.36,98,637.83,99,640.18,100.62Z" />
                </g>
            </g>
        </svg>
    </div>
