...
<template>
    <div class="lyric-toolbar" v-gesture-dnm="{ trigger: '.header' }">
        <div class="container">
            <div class="header">
                <div class="close-btn">
                    <svg @click="hideLyricToolbar" width="11" height="11" viewBox="0 0 593.14 593.11" data-name="Layer 1"
            ...
            <div class="center v-spacing">
                ...
                <div class="row">
                    <input type="number" placeholder="默认值28" :value="lyric.lineSpacing" min="1" max="100" step="1"
                        @input="updateLyricLineSpacing" />
                </div>
                <div class="row text v-spacing">进度 (毫秒)：</div>
                <div class="row">
